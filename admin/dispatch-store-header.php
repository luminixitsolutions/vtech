...
<li class="sidenav-item">
<a href="add-sell.php?storeid=<?php echo $_SESSION['storeid'];?>" class="sidenav-link">
...
<?php } ?>
<li class="sidenav-item">
<a href="view-sells.php?storeid=<?php echo $_SESSION['storeid'];?>" class="sidenav-link">
...
<?php } if(in_array("82", $Options)) {?>
         <li class="sidenav-item">
            <a href="assign-challan-to-dispatcher.php?storeid=<?php echo $_SESSION['storeid'];?>" class="sidenav-link">
                <i class="sidenav-icon feather icon-activity"></i>
