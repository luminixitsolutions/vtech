...
?>
 <div class="row">
                    ...
                    LEFT JOIN tbl_users tu ON ti.CustId=tu.id WHERE tu.ProjectId='103' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.PoInspection='Yes' AND ti.Type=2";
                            ...
                            <div class="col-sm-6 col-xl-2">
                               <a href="total-installations.php?projid=103&page=12&RmsIntegration7Days=Yes&title=RMS%20Integration%207%20days&subheadid=<?php echo $_GET['id'];?>">
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        <div class="d-flex align-items-center">
                                            <div class="ml-3">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_users tu LEFT JOIN tbl_installations ti ON ti.CustId=tu.id WHERE tu.ProjectId='103' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.RmsIntegration7Days='Yes' AND ti.Type=2";
                                                            echo $rncnt4 = getRow($sql4);
                            ...
                            <div class="col-sm-6 col-xl-2">
                               <a href="total-installations.php?projid=103&page=12&RmsIntegration90Days=Yes&title=RMS%20Integration%2090%20days&subheadid=<?php echo $_GET['id'];?>">
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        <div class="d-flex align-items-center">
                                            <div class="ml-3">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_users tu LEFT JOIN tbl_installations ti ON ti.CustId=tu.id WHERE tu.ProjectId='103' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.RmsIntegration90Days='Yes' AND ti.Type=2";
                                                            echo $rncnt4 = getRow($sql4);
 ...
 <div class="col-sm-6 col-xl-2">
                            ...
                            <div class="col-sm-6 col-xl-2">
                                  <a href="contractor-abstract.php?projid=103&subheadid=<?php echo $_GET['id'];?>&title=<?php echo $_GET['name'];?>">
                               <div class="card mb-4 bg-pattern-3-dark" style="height: 100px;">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        <div class="d-flex align-items-center">
