...
function employeeMenuSanitizeOptionsString($raw)
{
    ...
    // Accept assignable menu ids (form tree) and any id present in tbl_options.
    $valid = array_flip(array_unique(array_merge(
        array_map('intval', getMenuOptionIdsFlat()),
        employeeMenuAllValidOptionIds()
    )));
    $ids = [];
...
function employeeMenuFallbackOptionsForRoll($roll)
{
    $roll = (int) $roll;
    $map = [
        6 => [64, 55, 79, 80, 81, 10, 14],
        12 => [64, 55, 177, 10, 14],
        26 => [126, 60, 71, 82, 86, 165, 10, 14],
        27 => [125, 58, 59, 70, 165, 166, 10, 14],
        28 => [25, 26, 28, 10, 14],
        30 => [28, 135, 137, 164, 10, 14],
        31 => [121, 168, 169, 170, 171, 172, 173, 10, 14],
        43 => [18, 10, 14],
        44 => [64, 177, 178, 10, 14],
        45 => [64, 180, 181, 10, 14],
    ];
