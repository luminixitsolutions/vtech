...
function adminPageAccessSkipBasenames()
{
    return [
        ...
        'inc-pump-installation-import.php',
...
function adminPageAccessBasenameRules()
{
    return [
        ...
        'import-old-installed-data.php' => [68],
        'download-pump-installation-import-sample.php' => [68],
        ...
        'print-service-complaint.php' => [245, 28, 246],
        'service-abstract.php' => [247],
        'view-service-challans.php' => [260],
        'view-partial-material-challans.php' => [262],
        'view-insurance-service-complaints.php' => [263, 28, 246],
        'fill-insurance-details.php' => [263, 28, 246],
        'view-done-insurance-process.php' => [264, 28, 246],
        'add-insurance-complaint.php' => [245, 28],
        'ajax-get-customer-insurance.php' => [245, 28, 121],
        ...
        'driver-trip-billings.php' => [100], 'add-driver-trip-billing.php' => [100],
        'view-driver-trip-billing.php' => [100], 'driver-trip-billing-report.php' => [100],
        'driver-trip-billing-summary.php' => [100],
        ...
        'contractor-payment-dashboard.php' => [142],
        'contractor-payment-add.php' => [142],
        'contractor-payment-history.php' => [142],
        'contractor-advance-payment-add.php' => [142],
        'contractor-advance-payment-history.php' => [142],
        ...
        'add-driver.php' => [116], 'add-transportor.php' => [255],
        'add-installer.php' => [127],
        ...
        'total-beneficiary.php' => [68, 106, 134],
