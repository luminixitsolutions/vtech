    ...
    <div class="layout-wrapper layout-2">
        ...
        <th>Amount</th> -->
                  ...
                  WHERE tcp.CustId='".$_GET['CustId']."' AND tp.Roll=0";*/
                                                                $sql12 = "SELECT tcp.* FROM tbl_cust_product_specification tcp 
                  WHERE tcp.CustId='" . $_GET['CustId'] . "'";
                                                                $rncnt2 = getRow($sql12);
                                                                $row12 = getList($sql12);
                                                                foreach ($row12 as $result) {
                                                                    ...
                                                                    $sql22 = "SELECT * FROM tbl_sell_products WHERE UserId='" . $_GET['CustId'] . "' AND ProductId='" . $result['ProdId'] . "' AND BranchId='" . $_REQUEST["BranchId"] . "'";
                                                                        ...
                                                                        <tr style="<?php echo $bgcolor; ?>">
                                                                            <td>
                                                                                <label class="custom-control custom-checkbox">
                                                                                    <input type="checkbox" id="Check_Id<?php echo $result['ProdId']; ?>" value="0" class="custom-control-input is-valid" onclick="featured2(<?php echo $result['ProdId']; ?>)" <?php echo $checkstatus . " " . $disabled; ?>>
                                                                                    <span class="custom-control-label">&nbsp;</span>
                                                                                </label>
                                                                            </td>
                                                                            <input type="hidden" value="<?php echo $checkval; ?>" name="CheckId[]" id="CheckId<?php echo $result['ProdId']; ?>">
                                                                            <td><?php echo $result['ProdName']; ?></td>
...
<div class="form-group col-md-4" style="padding-top:10px;">
                                        ...
                                        Parital Material Dispatch</option>
                                                ...
                                                <div class="form-group col-md-4" style="padding-top:10px;">
                                                    ...
                                                    <select class="form-control" name="ChallanType" id="ChallanType" required>
                                        <option selected="" value="">Select Challan Type</option>

                                        <option <?php if($_REQUEST["ChallanType"] == 1) { ?> selected <?php } ?> value="1">
                                        Regular Challan</option>
                                        
                                        <option <?php if($_REQUEST["ChallanType"] == 2) { ?> selected <?php } ?> value="2">
                                        Service Replacement Challan</option>
