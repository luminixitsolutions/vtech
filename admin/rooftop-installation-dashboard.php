                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-md-12">
                                <div class="card ui-task mb-4">
                                    <h5 class="card-header" style="text-align:center;">ROOFTOP PROJECT DASHBOARD</h5>
                                    <div class="card-body">
                            ...
                            <div class="col-sm-6 col-xl-3">
                                <a href="rooftop-installation-project-dashboard.php?id=1&name=Maharashtra">
                               <div class="card bg-warning text-white ui-hover-icon mb-4 bg-pattern-3">
                                        <div class="card-body text-center">
                                       
                                        <h6 class="mb-0">Maharashtra Project</h6>
                            ...
                            <div class="col-sm-6 col-xl-3">
                                <a href="rooftop-installation-project-dashboard.php?id=2&name=Madhya Pradesh">
                               <div class="card bg-warning text-white ui-hover-icon mb-4 bg-pattern-3">
                                        <div class="card-body text-center">
                                       
                                        <h6 class="mb-0">Madhya Pradesh Project</h6>
                                        <i class="lnr lnr-users hov-icon"></i>
                                     </div>
                                </div></a>
                            </div>
