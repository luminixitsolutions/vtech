              ...
              <?php include_once '../top_header.php'; ?>
                ...
                <div class="layout-content">
                    ...
                    <div class="container flex-grow-1 container-p-y">
                        <h5 class="font-weight-bold py-3 mb-0">Task Management Dashboard</h5>
                               ...
                               <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                        ...
                                                        ?></h2>
                                        <h6 class="mb-0" style="color: black;">Total Task</h6>
                                     </div>
                                </div></a>
                            </div>
                            
                            <div class="col-sm-6 col-xl-2">
                                <a href="view-tasks.php?FromDate=<?php echo date('Y-m-d');?>&ToDate=<?php echo date('Y-m-d');?>">
                               <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                        ...
                                                        ?></h2>
                                        <h6 class="mb-0" style="color: black;">Today Tasks</h6>
                                     </div>
                                </div></a>
                            </div>

 <div class="col-sm-6 col-xl-2">
                                <a href="view-tasks.php?ClainStatus=Pending">
                               <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                        ...
                                                        ?></h2>
                                        <h6 class="mb-0" style="color: black;">Pending Tasks</h6>
                                     </div>
                                </div></a>
                            </div>
                            
                            <div class="col-sm-6 col-xl-2">
                                <a href="view-tasks.php?ClainStatus=In Process">
                               <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                        ...
                                                        ?></h2>
                                        <h6 class="mb-0" style="color: black;">In Process Tasks</h6>
                                     </div>
                                </div></a>
                            </div>
                            
                            <div class="col-sm-6 col-xl-2">
                                <a href="view-tasks.php?ClainStatus=Closed">
                               <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                        ...
                                                        ?></h2>
                                        <h6 class="mb-0" style="color: black;">Closed Tasks</h6>
                                     </div>
                                </div></a>
                            </div>
                            
                            <div class="col-sm-6 col-xl-2">
                                <a href="view-tasks.php?ClainStatus=Cancelled">
                               <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                        ...
                                                        ?></h2>
                                        <h6 class="mb-0" style="color: black;">Cancelled Tasks</h6>
                                     </div>
                                </div></a>
                            </div>
