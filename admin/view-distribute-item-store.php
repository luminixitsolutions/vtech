...
#example thead th.sorting::before,
#example thead th.sorting::after,
#example thead th.sorting_asc::before,
#example thead th.sorting_asc::after,
#example thead th.sorting_desc::before,
...
<table id="example" class="table table-striped table-bordered table-sm">
        ...
        <tbody>
            ...
            $dispatchOfficerMap = $canAssignDispatch ? buildStoreDistDispatchOfficerMap($conn, $listDistIds) : [];
            $totQtyMap = buildStoreDistTotQtyMap($conn, $listDistIds);
...
function loadDispatchHistory() {
    ...
    $.post('ajax_store_dist_dispatch_history.php', { store_dist_id: id }, function (res) {
        if (res && res.ok) {
