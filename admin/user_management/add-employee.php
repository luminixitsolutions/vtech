...
<div class="clearfix"></div>
 ...
 <div class="form-group col-md-12">
                                       ...
                                       <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group col-md-2">
                                            <label class="form-label">Immediate Boss <span class="text-danger">*</span></label>
                                            <select class="form-control" id="ImmediateBoss" name="ImmediateBoss" required="">
                                               <option value="0" <?php if($row7["ImmediateBoss"]=='0') {?> selected
                                                    <?php } ?>>No</option>
                                                <option value="1" <?php if($row7["ImmediateBoss"]=='1') {?> selected
                                                    <?php } ?>>Yes</option>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <select class="form-control" id="OfficeEmployee" name="OfficeEmployee">
                                                <option value="0" <?php if (!isset($row7['OfficeEmployee']) || $row7['OfficeEmployee'] == '0' || $row7['OfficeEmployee'] === '') { ?> selected <?php } ?>>No</option>
                                                <option value="1" <?php if (isset($row7['OfficeEmployee']) && $row7['OfficeEmployee'] == '1') { ?> selected <?php } ?>>Yes</option>
                                            </select>
                                            <div class="clearfix"></div>
                                        </div>
...
<div class="form-group col-md-3">
<label class="form-label"> Under By Immediate Boss</label>
 <select class="select2-demo form-control" name="ImmediateBossId" id="ImmediateBossId">
<option selected="" value="0">No One</option>
 <?php 
  $sql12 = "SELECT * FROM tbl_users WHERE Status='1' AND ImmediateBoss=1";
  $row12 = getList($sql12);
  foreach($row12 as $result){
     ?>
  <option <?php if($row7["ImmediateBossId"] == $result['id']) {?> selected <?php } ?> value="<?php echo $result['id'];?>">
    <?php echo $result['Fname']." (".$result['Phone'].")"; ?></option>
<?php } ?>
</select>
<div class="clearfix"></div>
                        ...
                        <div class="form-group col-md-3 showall">
                                            <label class="form-label">Roll </label>
                                            <select class="form-control" name="Roll" id="Roll" required>
                                                <option value="" <?php echo (!isset($_GET['id']) || $_GET['id'] === '') ? 'selected' : ''; ?>>Select Roll</option>
                                                <?php 
                                        $q = "select * from tbl_user_type WHERE Status=1 AND id NOT IN (26,27,34,35,36,37) ORDER BY Name";
                                        $r = $conn->query($q);
                                ...
                                ?>
                                        ...
                                        <div class="form-group col-md-3 showall">
                                            <label class="form-label">Under By Manager </label>
                                            <select class="form-control" name="UnderByManager" id="UnderByManager">
                                                <option selected="" value="0">No Manager</option>
                                                <?php 
                                        $q = "select id,Fname from tbl_users WHERE Status=1 AND Roll=12 ORDER BY Fname";
                                        $r = $conn->query($q);
                                        while($rw = $r->fetch_assoc())
                                    {
                                ?>
                                                <option <?php if($row7['UnderByManager']==$rw['id']){ ?> selected <?php } ?>
                                          ...
                                          <div class="form-group col-md-3 showall">
                                            <label class="form-label">Under By General Manager </label>
                                            <select class="form-control" name="UnderByGrManager" id="UnderByGrManager">
                                                <option selected="" value="0">No General Manager</option>
                                                <?php 
                                        $q = "select id,Fname from tbl_users WHERE Status=1 AND Roll=44 ORDER BY Fname";
                                        $r = $conn->query($q);
                                        while($rw = $r->fetch_assoc())
                                    {
                                ?>
                                                <option <?php if($row7['UnderByGrManager']==$rw['id']){ ?> selected <?php } ?>
                                                    value="<?php echo $rw['id']; ?>"><?php echo $rw['Fname']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                         ...
                                         <div class="form-group col-md-3 showall">
                                            <label class="form-label">Under By Business Head </label>
                                            <select class="form-control" name="UnderByBusHead" id="UnderByBusHead">
                                                <option selected="" value="0">No Business Head</option>
                                                <?php 
                                        $q = "select id,Fname from tbl_users WHERE Status=1 AND Roll=45 ORDER BY Fname";
                                        $r = $conn->query($q);
                                        while($rw = $r->fetch_assoc())
                                    {
                                ?>
                                                <option <?php if($row7['UnderByBusHead']==$rw['id']){ ?> selected <?php } ?>
                                                    value="<?php echo $rw['id']; ?>"><?php echo $rw['Fname']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>

                                        <!--<div class="form-group col-md-4 showonly" <?php if($row7['UnderUser']==0){?> style="display:none;"<?php } else{?> style="display: block;"<?php } ?>>
                                            <label class="form-label">Roll </label>
                                            <select class="form-control" name="Roll" id="Roll">
                                               
                                                <?php 
                                        $q = "select * from tbl_user_type WHERE Status=1 AND id=32 ORDER BY Name";
                                        $r = $conn->query($q);
                                        while($rw = $r->fetch_assoc())
                                    {
                                ?>
