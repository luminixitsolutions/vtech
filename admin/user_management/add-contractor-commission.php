            ...
            <div class="layout-container">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if (($_GET['UserId'] ?? '') == '') {
                        ...
                        $sql = "DELETE FROM tbl_contractor_commision WHERE UserId='$UserId' AND ProjectHeadId='$ProjectHeadId' AND ProjectSubHeadId='$ProjectSubHeadId'";
                        $conn->query($sql);
                        if ($_POST["Capacity"] != '') {
                            $number = count($_POST["Capacity"]);
                            if ($number > 0) {
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" id="ProjectSubHeadId" name="ProjectSubHeadId" required>
                                                ...
                                                <?php
                                                $q = "select * from tbl_project_sub_head WHERE Status='1' AND UnderBy='" . $row7['ProjectHeadId'] . "'";
                                                $r = $conn->query($q);
                                                while ($rw = $r->fetch_assoc()) {
                                                ?>
