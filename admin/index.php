...
<meta name="description" content="VTECH Admin Sign In" />
...
<div class="admin-auth-shell">
    <aside class="admin-auth-hero" aria-hidden="true">
        <div class="admin-auth-hero-inner">
            ...
            <p>Secure access to your solar operations dashboard — manage projects, inventory, leads, and field teams in one place.</p>
            <ul class="admin-auth-features">
                <li><span><i class="fas fa-shield-alt"></i></span> Two-step verification for every sign in</li>
                <li><span><i class="fas fa-chart-line"></i></span> Real-time project &amp; stock tracking</li>
    ...
    <main class="admin-auth-panel">
        <div class="admin-auth-card">
            ...
            <h2>Welcome back</h2>
            <p class="admin-auth-subtitle">Sign in to continue to your admin account</p>
            ...
            <form id="validation-form" method="post" novalidate>
                ...
                <div class="admin-auth-field">
                    <label for="Project">Project <span style="color:#c0392b">*</span></label>
                    <div class="admin-auth-input-wrap">
