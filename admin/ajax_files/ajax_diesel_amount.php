...
$qx = "INSERT INTO tbl_diesel_amount SET TripId = '$TripId',Status='$Status',DriverId = '$DriverId',Amount='$Amount',Narration='$Narration',CrDate='$CrDate',CreatedBy='$user_id',CreatedDate='$CreatedDate'";
	$conn->query($qx);
	echo 1;
}
...
$ModifiedDate = date('Y-m-d');
  $query2 = "UPDATE tbl_diesel_amount SET Status='$Status',Amount='$Amount',Narration='$Narration',CrDate='$CrDate',ModifiedBy='$user_id',ModifiedDate='$ModifiedDate' WHERE id = '$id'";
 	$conn->query($query2);
  echo 1;
}
