...
/*$query = "SELECT * FROM tbl_common_master WHERE Name = '$Name' AND Roll='$Roll'";
...
$qx = "INSERT INTO tbl_common_master SET Amount='$Amount',RangeFrom = '$RangeFrom',RangeTo='$RangeTo',PumpHeadId='$PumpHeadId',Level='$Level',Name = '$Name',Status='$Status',Roll='$Roll',ExpTitle='$ExpTitle'";
	$conn->query($qx);
	echo 1;
}
/*}*/
...
/*$query = "SELECT * FROM tbl_common_master WHERE Name = '$Name' AND id != '$id' AND Roll='$Roll'";
$result = $conn->query($query);
$row_cnt = mysqli_num_rows($result);
if($row_cnt > 0){
  echo 0;
  ...
  $query2 = "UPDATE tbl_common_master SET Amount='$Amount',RangeFrom = '$RangeFrom',RangeTo='$RangeTo',PumpHeadId='$PumpHeadId',Level='$Level',Name = '$Name', Status='$Status',Roll='$Roll',ExpTitle='$ExpTitle' WHERE id = '$id'";
 	$conn->query($query2);
 /*}*/
  echo 1;
}
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
 ...
 $srno = 1;
  ...
  $sql = "SELECT * FROM tbl_common_master WHERE Roll='$Roll' ORDER BY id DESC";
   $rx = $conn->query($sql);
  while($nx = $rx->fetch_assoc()){
        $sql2 = "SELECT Name As PumpHead FROM tbl_common_master 
        WHERE id='".$nx['PumpHeadId']."'";
        $row2 = getRecord($sql2);
  ?>
           <tr>
             <td><?php echo $srno; ?></td>
             ...
             <td><?php if($nx['Level']=='1'){echo "<span style='color:green;'>Summer Level</span>";} else { echo "<span style='color:red;'>Depth Level</span>";} ?></td>
                ...
                <td><?php echo $nx['RangeFrom']."-".$nx['RangeTo']; ?> mtrs</td>
