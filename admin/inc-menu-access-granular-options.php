...
function menuAccessGranularDefinitions()
{
    return [
        ...
        263 => ['label' => 'Insurance Service Complaint', 'legacy' => [28, 246]],
        264 => ['label' => 'Done Insurance Process', 'legacy' => [28, 246]],
...
function menuAccessGranularPagePrimaryIds()
{
    return [
        ...
        'view-insurance-service-complaints.php' => 263,
        'fill-insurance-details.php' => 263,
        'view-done-insurance-process.php' => 264,
