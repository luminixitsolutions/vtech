...
<div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="CellNo2" id="CellNo2" class="form-control"
                                                placeholder="" value="<?php echo $row7["CellNo2"]; ?>"
                                                autocomplete="off" >
                                            <div class="clearfix"></div>
                                        </div>
...
<option selected="" value="">Select</option>
 <?php 
  $sql12 = "SELECT * FROM tbl_common_master WHERE Status='1' AND Roll=26";
  $row12 = getList($sql12);
  foreach($row12 as $result){
     ?>
  <option <?php if($row7['Priority'] == $result['Name']){?> selected <?php } ?> value="<?php echo $result['Name'];?>">
    <?php echo $result['Name']; ?></option>
<?php } ?>
</select>
<div class="clearfix"></div>
