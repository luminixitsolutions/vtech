 ...
 <div class="row">
                    ...
                    LEFT JOIN tbl_users tu ON tdo.CustId=tu.id WHERE tdo.Inst_Dispatcher_Otp_Verify=1 AND tu.ProjectId='102' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND tu.ProjectType=1";
                          ...
                          <div class="col-sm-6 col-xl-2">
                            ...
                            <div class="col-sm-6 col-xl-2">
                               <a href="total-beneficiary.php?roll=work_order_done&projid=102&val=&subheadid=<?php echo $_GET['id'];?>&title=Work Order Done">
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        <div class="d-flex align-items-center">
                                            <div class="ml-3">
                                                <h6 class="mb-0" style="color: black;">Work Order Done</h6>
                                                <div class="text-large"><?php echo (int) $medaWorkDone; ?></div>
                                            </div>
                                        </div>
                                     </div>
                                </div></a>
                            ...
                            <div class="col-sm-6 col-xl-2">
                               <a href="total-beneficiary.php?roll=work_order_pending&projid=102&val=&subheadid=<?php echo $_GET['id'];?>&title=Work Order Pending">
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        <div class="d-flex align-items-center">
                                            <div class="ml-3">
                                                <h6 class="mb-0" style="color: black;">Work Order Pending</h6>
                                                <div class="text-large"><?php echo (int) $medaWorkPending; ?></div>
                                            </div>
                                        </div>
                                     </div>
                                </div></a>
                    ...
                    LEFT JOIN tbl_users tu ON ti.CustId=tu.id WHERE tu.ProjectId='102' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.PoInspection='Yes' AND ti.Type=2";
                          ...
                          <div class="col-sm-6 col-xl-2">
                            ...
                            <div class="col-sm-6 col-xl-2">
                               <a href="total-installations.php?projid=102&page=12&RmsIntegration7Days=Yes&title=RMS%20Integration%207%20days&subheadid=<?php echo $_GET['id'];?>">
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        <div class="d-flex align-items-center">
                                            <div class="ml-3">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_users tu LEFT JOIN tbl_installations ti ON ti.CustId=tu.id WHERE tu.ProjectId='102' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.RmsIntegration7Days='Yes' AND ti.Type=2";
                                                            echo $rncnt4 = getRow($sql4);
                            ...
                            <div class="col-sm-6 col-xl-2">
                               <a href="total-installations.php?projid=102&page=12&RmsIntegration90Days=Yes&title=RMS%20Integration%2090%20days&subheadid=<?php echo $_GET['id'];?>">
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        <div class="d-flex align-items-center">
                                            <div class="ml-3">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_users tu LEFT JOIN tbl_installations ti ON ti.CustId=tu.id WHERE tu.ProjectId='102' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.RmsIntegration90Days='Yes' AND ti.Type=2";
                                                            echo $rncnt4 = getRow($sql4);
