...
<div class="page-loader">
 ...
 <div id="layout-sidenav" class="layout-sidenav sidenav sidenav-vertical bg-white logo-dark">
    ...
    <ul class="sidenav-inner">
        ...
        <?php if (userHasAnyMenuOption($Options, menuAccessServiceComplaintOptionIds())) { ?>
        <li class="sidenav-item">
        ...
        <?php 
                            ...
                            ?>
        <li class="sidenav-item">
            <a href="service-project-sub-head-dashboard.php?id=<?php echo $result['id'];?>&name=<?php echo $result['Name'];?>" class="sidenav-link sidenav-toggle">
            ...
            <ul class="sidenav-menu">
                <?php 
                            ...
                            ?>
                <li class="sidenav-item">
<a href="service-project-dashboard.php?prjid=<?php echo $result['id'];?>&id=<?php echo $result2['id'];?>&name=<?php echo $result2['Name'];?>" class="sidenav-link">
