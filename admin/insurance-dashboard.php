...
<div class="ins-dash-hero">
    <h4>Insurance Site Dashboard</h4>
    <p>Overview of pending, active, renewal, and expired insurance across site-dispatched customers.</p>
...
<div class="row">
    ...
    <div class="col-lg-4 mb-4">
        <div class="ins-dash-chart-card">
            <h6 class="ins-dash-chart-title">Project Type Split</h6>
            <div class="ins-dash-chart-wrap">
...
<div class="card ins-dash-shell">
    <h5 class="card-header ins-dash-header">Pump vs Rooftop Summary</h5>
    <div class="card-body ins-dash-body">
        <div class="ins-dash-mini-grid">
            <div class="ins-dash-mini-card">
                <h5><?php echo number_format($dash['pump_pending']); ?></h5>
                <p>Pump Pending</p>
            </div>
            <div class="ins-dash-mini-card">
                <h5><?php echo number_format($dash['rooftop_pending']); ?></h5>
                <p>Rooftop Pending</p>
            </div>
            <div class="ins-dash-mini-card">
                <h5><?php echo number_format($dash['pump_active']); ?></h5>
                <p>Pump Active</p>
            </div>
            <div class="ins-dash-mini-card">
                <h5><?php echo number_format($dash['rooftop_active']); ?></h5>
                <p>Rooftop Active</p>
            </div>
        </div>
    </div>
...
(function() {
    ...
    new Chart(document.getElementById('projectTypeChart'), {
        type: 'pie',
        data: {
            labels: ['Pump Pending', 'Rooftop Pending', 'Pump Active', 'Rooftop Active'],
            datasets: [{
                data: [
                    <?php echo (int) $dash['pump_pending']; ?>,
                    <?php echo (int) $dash['rooftop_pending']; ?>,
                    <?php echo (int) $dash['pump_active']; ?>,
                    <?php echo (int) $dash['rooftop_active']; ?>
                ],
                backgroundColor: ['#f97316', '#fb7185', '#22c55e', '#14b8a6'],
                borderWidth: 0
            }]
        },
        options: Object.assign({}, chartDefaults, {
