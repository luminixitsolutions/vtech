              ...
              <?php include_once '../top_header.php'; ?>
                ...
                <div class="layout-content">
                    ...
                    <div class="container flex-grow-1 container-p-y">
                        <h5 class="font-weight-bold py-3 mb-0">View Opportunity Dealer List </h5>
...
<?php } ?>
    ...
    <script>
        ...
        $(document).ready(function(){
         ...
         $('#empTable').DataTable({
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url':'pagination/lead-completed-customer.php',
                   method: "POST",
                    data: {
                        Roll: Roll,
                        ClainReason:ClainReason,
                        FromDate:FromDate,
                        ToDate:ToDate
                    },
   ...
   var Roll = $('#Roll').val();
    ...
    $.fn.myFunction(Roll,ClainReason,FromDate,ToDate);
