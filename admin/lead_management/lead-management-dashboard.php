...
<head>
    <title><?php echo $Proj_Title; ?> | Lead Dashboard</title>
    <meta charset="utf-8">
        ...
        <div class="layout-inner">
            ...
            <div class="layout-container">
                ...
                <div class="layout-content">
                    <div class="container-fluid flex-grow-1 container-p-y lead-dash-page">

                        <div class="lead-dash-hero">
                            <h4>Lead Management Dashboard</h4>
                            <p>Track lead sources, status pipeline, assignments, and marketing activity at a glance.</p>
                            <div class="lead-dash-hero-meta">
                                ...
                                <span class="lead-dash-hero-pill"><i class="feather icon-plus-circle"></i> <?php echo number_format($dash['added_today']); ?> leads added today</span>
                            </div>
                        </div>

                        <div class="card lead-dash-shell">
                            <h5 class="card-header lead-dash-header">Lead Overview</h5>
                            <div class="card-body lead-dash-body">
                                <div class="lead-dash-stat-grid">
                                    <?php
                                    leadDashboardStatCard('Total Leads', $dash['total'], 'view-leads.php', 'layers', 'All leads in system', 'total');
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-4">
                                <div class="lead-dash-chart-card">
                                    <h6 class="lead-dash-chart-title">Monthly Leads Created (Last 6 Months)</h6>
                                    <div class="lead-dash-chart-wrap">
