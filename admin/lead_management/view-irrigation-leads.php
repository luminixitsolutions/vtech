              ...
              <?php include_once '../top_header.php'; ?>
                ...
                <div class="layout-content">
                    ...
                    <div class="container flex-grow-1 container-p-y">
                        <h5 class="font-weight-bold py-3 mb-0">View <?php echo $_REQUEST['ClainReason'];?> Irrigation Lead List
    <?php if(in_array("14", $Options)) {?>   
<span style="float: right;">
<a href="add-irrigation-leads.php" class="btn btn-secondary btn-round"><i class="ion ion-md-add mr-2"></i> Create Irrigation Lead</a></span><?php } ?></h5>
...
{
  $id = $_REQUEST["id"];
  $sql11 = "DELETE FROM tbl_irrigation_leads WHERE id = '$id'";
  $conn->query($sql11);
  ?>
    <script type="text/javascript">
      alert("Deleted Successfully!");
      window.location.href="view-irrigation-leads.php";
    </script>
<?php } ?>
<br>
                    <div class="card mb-4">
...
<tr>
   ...
   <th>Interested in Drip/Sprinkler</th>
   <th>Crops Grown</th>
   <th>Soil Testing?</th>
...
<input type="hidden" id="Roll" value="<?php echo $Roll;?>">
   ...
   <script type="text/javascript" src="<?php echo $SiteUrl;?>/assets/js/datatables.min.js"></script>
    ...
    <script>
        ...
        $(document).ready(function(){
         ...
         $('#empTable').DataTable({
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url':'pagination/lead-irrigation-customer.php',
                    method: "POST",
                    data: {
    ...
    { data: 'CurrentIrrigationMethod' },
    { data: 'InterestedInIrrigation' },
    { data: 'CropsGrown' },
    { data: 'InterestedSoilTesting' },
