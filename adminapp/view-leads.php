...
<div class="container-fluid flex-grow-1 container-p-y">
 <?php if($_GET['ClainReason'] != ''){?>
<h4 class="font-weight-bold py-3 mb-0"><?php echo $_GET['ClainReason'];?> Leads</h4>
<?php } else if($_GET['ClainStatus'] != ''){?>
<h4 class="font-weight-bold py-3 mb-0"><?php echo $_GET['ClainStatus'];?> Leads</h4>
<?php } else {?>
<h4 class="font-weight-bold py-3 mb-0">Total Leads</h4>
<?php } ?>
...
<?php include_once 'footer.php'; ?>
    ...
    <script src="js/app.js"></script>
       <?php include_once 'footer_script.php'; ?>
        ...
        $(document).ready(function(){
         $.fn.myFunction = function(ClaimReason,ClaimStatus){ 
    ...
    $.fn.myFunction(ClaimReason,ClaimStatus);
