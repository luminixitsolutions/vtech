...
<?php  
                if(isset($_POST['submit'])){
                    ...
                    echo "<script>window.location.href='print-rooftop-project-abstract.php?District=$District&projid=$projid&SubHeadProjectId=$SubHeadProjectId';</script>";
  ...
  <?php echo $_GET['title'];?> PROJECT ABSTRACT
</h5>
...
<option selected="" value="all">All District</option>
 <?php 
        ...
        $q = "select DISTINCT(District) As District from tbl_users WHERE District!='' AND ProjectId='".$_GET['projid']."' AND ProjectType=2 ORDER BY District ASC";
        $r = $conn->query($q);
