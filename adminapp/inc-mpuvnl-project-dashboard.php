<div class="row text-center mt-4">
    ...
    <a href="project-abstract.php?projid=106&subheadid=<?php echo $_GET['id']; ?>&title=<?php echo urlencode($_GET['name']); ?>" class="project-card">
...
<div class="col-6 col-md-3">
    <a href="project-abstract-of-abstract.php?projid=106&subheadid=<?php echo $_GET['id']; ?>&title=MPUVNL PM KUSUM B (PMKMSY)" class="project-card">
        <div class="card custom-card mb-4" style="height: 100px;">
            <div class="card-body text-center d-flex align-items-center justify-content-center">
...
<div class="col-6 col-md-3">
    <a href="#" class="project-card">
        <div class="card custom-card mb-4">
            <div class="card-body text-center">
                <div class="project-name">RMS Integration 7 days</div>
                <div class="project-count">
                    <?php
                        $sql4 = "SELECT * FROM tbl_users tu
                                 LEFT JOIN tbl_installations ti ON ti.CustId = tu.id
                                 ...
                                 AND tu.ProjectSubHeadId = '".$_GET['id']."'
                                 AND tu.Roll = 5
                                 AND ti.RmsIntegration7Days = 'Yes'
                                 AND ti.Type = 2";
                        echo $rncnt4 = getRow($sql4);
                    ?>
                </div>
...
<div class="col-6 col-md-3">
    <a href="#" class="project-card">
        <div class="card custom-card mb-4">
            <div class="card-body text-center">
                <div class="project-name">RMS Integration 90 days</div>
                <div class="project-count">
                    <?php
                        $sql4 = "SELECT * FROM tbl_users tu
                                 LEFT JOIN tbl_installations ti ON ti.CustId = tu.id
                                 ...
                                 AND tu.ProjectSubHeadId = '".$_GET['id']."'
                                 AND tu.Roll = 5
                                 AND ti.RmsIntegration90Days = 'Yes'
                                 AND ti.Type = 2";
                        echo $rncnt4 = getRow($sql4);
                    ?>
                </div>
