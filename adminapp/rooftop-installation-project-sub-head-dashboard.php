...
@media (max-width: 576px) {
  ...
  <?php echo strtoupper($_GET['name']); ?> PROJECT SUB HEAD
</h5>
...
<div class="col-6 col-md-3">
    <a href="rooftop-installation-project-dashboard-2.php?prjid=<?php echo $_GET['id']; ?>&id=<?php echo $subHeadId; ?>&name=<?php echo urlencode($result['Name']); ?>" class="project-card">
        <div class="card custom-card mb-4">
            <div class="card-body text-center">
                <div class="project-name"><?php echo $result['Name']; ?></div>
                <div class="project-count"><?php echo $rncnt4; ?></div>
            </div>
        </div>
    </a>
</div>
