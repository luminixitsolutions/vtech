...
<?php } ?>
 ...
 <div class="col-4 col-md-2 mb-3">
                                ...
                                <p class="text-secondary"><small style="font-size: 12px;font-weight: 700;font-family: Sans-serif;text-transform: uppercase;color:#000;">Exe App 2</small></p>
                            </div>
                             <!--<div class="col-4 col-md-2 mb-3">
                                <a href="">
                                    <div class="avatar avatar-70 mb-1 rounded">
