                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" name="FromBranchId" id="FromBranchId" onchange="this.form.submit()">
                                            ...
                                            <?php
                                            $sqlb = "SELECT * FROM tbl_rooftop_branch WHERE Status='1'";
                                            $rb = $conn->query($sqlb);
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" name="ToBranchId" id="ToBranchId" required onchange="this.form.submit()">
                                            <option value="">Select Store</option>
                                            <?php
                                            $sqlb2 = "SELECT * FROM tbl_rooftop_branch WHERE Status='1' AND id!='$FromBranchId'";
                            ...
                            if ($FromBranchId > 0 && $ToBranchId > 0) {
                                ...
                                <form method="post" action="item_transfer_workflow/save-store-to-store-transfer.php" id="storeTransferForm">
                                    ...
                                    <table class="table table-bordered table-sm" id="tblQty">
                                        ...
                                        <tbody>
                                        <?php
                                        $sq = "SELECT ts.ProductId, tp.ProductName, tp.Unit AS Purity, (SELECT COALESCE(SUM(Qty),0) FROM tbl_rooftop_distibute_item_details WHERE ProductId=ts.ProductId AND ProdType=0 AND BranchId='$FromBranchId') AS CrQty, (SELECT COALESCE(SUM(Qty),0) FROM tbl_rooftop_distibute_item_details2 WHERE ProductId=ts.ProductId AND ProdType=0 AND BranchId='$FromBranchId') AS DrQty FROM tbl_rooftop_distibute_item_details ts INNER JOIN tbl_products tp ON ts.ProductId=tp.id WHERE ts.ProdType=0 AND ts.BranchId='$FromBranchId' GROUP BY ts.ProductId, tp.ProductName, tp.Unit";
                                        $rq = $conn->query($sq);
                                        $has_qty = false;
                                    ...
                                    <table class="table table-bordered table-sm" id="tblSerial">
                                        ...
                                        $ss = "SELECT d.id, d.ProductName, d.SerialNo, d.ProductId, d.ProdType
                                               ...
                                               WHERE d.BranchId='$FromBranchId'
                                                 ...
                                                 AND NOT EXISTS (
                                                     SELECT 1
                                                     FROM tbl_rooftop_store_to_store_transfer_details td
                                                     INNER JOIN tbl_rooftop_store_to_store_transfer t ON t.id=td.TransferId
