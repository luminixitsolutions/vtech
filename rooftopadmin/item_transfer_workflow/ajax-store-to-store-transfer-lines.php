...
FROM tbl_rooftop_store_to_store_transfer t
LEFT JOIN tbl_rooftop_branch tb1 ON t.FromBranchId = tb1.id
LEFT JOIN tbl_rooftop_branch tb2 ON t.ToBranchId = tb2.id
WHERE $w");
if (!$t || empty($t['id'])) {
...
FROM tbl_rooftop_store_to_store_transfer_details d
