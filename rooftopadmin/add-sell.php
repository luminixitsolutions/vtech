                                                ...
                                                <div class="form-group col-md-8">
                                                    ...
                                                    <select class="select2-demo form-control" name="CustId" id="CustId" required onchange="getItem2(this.value)">
                                                        ...
                                                        if ($Roll == 1 || $Roll == 7) {
                                                            ...
                                                            /*  $sql12 = "SELECT tu.id,tu.Fname,tu.Lname,tu.Phone FROM tbl_users tu WHERE tu.DispatchOfficerStatus=1 AND tu.ProjectType=2 AND tu.Roll=5 AND tu.BranchId='$BranchId'"; */
                                                        }
                                                        //echo $sql12;
                                                        $row12 = getList($sql12);
                                                        foreach ($row12 as $result) {
...
if($BalQty > 0){
                                                                ...
                                                                ?>
                                                                        <tr style="<?php echo $bgcolor; ?>">
                                                                            ...
                                                                            <input type="hidden" value="<?php echo $checkval; ?>" name="CheckId[]" id="CheckId<?php echo $result['id']; ?>">
