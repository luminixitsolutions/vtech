                        ...
                        <div class="col-xl-12 col-md-12">
                            <div class="card ui-task mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <?php
                                        $sql = "SELECT * FROM tbl_rooftop_project_sub_head WHERE UnderBy='" . (int) $_GET['id'] . "'";
                                        $row = getList($sql);
                                        foreach ($row as $result) {
                                        ?>
                                        <div class="col-sm-6 col-xl-3">
                                            <a href="service-project-dashboard.php?prjid=<?php echo (int) $_GET['id']; ?>&id=<?php echo $result['id']; ?>&name=<?php echo $result['Name']; ?>">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="ml-3">
                                                                ...
                                                                <div class="text-large"><?php
                                                                    $sql4 = "SELECT ts.* FROM tbl_rooftop_service_complaint ts
                                                                        INNER JOIN tbl_users tu ON tu.id = ts.CustId
                                                                        WHERE tu.ProjectSubHeadId='" . $result['id'] . "'
