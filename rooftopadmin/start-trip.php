...
if (isset($_POST['submit'])) {
    ...
    $otherTrip = getRecord("SELECT id FROM tbl_rooftop_trip_details WHERE DriverId='$driverId' AND Status=0 AND id!='$id' LIMIT 1");
    if ($otherTrip) {
