...
$po = getRecord("SELECT InvoiceNo FROM tbl_rooftop_purchase_order WHERE id='$poId' AND Status=1 LIMIT 1");
if (!is_array($po)) {
...
$html = renderRooftopPoAssignmentActivityLogHtml($conn, $poId);
echo json_encode([
    'ok' => true,
    'html' => $html,
