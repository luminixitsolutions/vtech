...
if($DealerAmt > 0){
    $sql = "INSERT INTO tbl_dealer_general_ledger SET DealerId='$DealerId',UserId='$EmpId',AccountName='$Fname',Amount='$DealerAmt',PaymentDate='$CreatedDate',CrDr='cr',Roll=2,Type='DINV',CreatedDate='$CreatedDate',SellType='DealerInv'";
    $conn->query($sql);
}
...
echo 1;
     ...
     $sql2 = "SELECT * FROM tbl_users WHERE Roll=5 AND Phone='$Phone' AND id!='$id' AND ProjectType=2";
 $rncnt2 = getRow($sql2);
 if($rncnt2 > 0){
    echo 0;
 }  
...
$conn->query($sql);
$sql = "DELETE FROM tbl_dealer_general_ledger WHERE UserId='$id'";
$conn->query($sql);
...
if($DealerAmt > 0){
    $sql = "INSERT INTO tbl_dealer_general_ledger SET DealerId='$DealerId',UserId='$id',AccountName='$Fname',Amount='$DealerAmt',PaymentDate='$CreatedDate',CrDr='cr',Roll=2,Type='DINV',CreatedDate='$CreatedDate',SellType='DealerInv'";
    $conn->query($sql);
}
