...
$ImmediateBossId = addslashes(trim($_POST['ImmediateBossId']));
$ImmediateBoss = addslashes(trim($_POST['ImmediateBoss']));
$CreatedDate = date('Y-m-d');
$RooftopBranchId = addslashes(trim($_POST['RooftopBranchId']));

if($_POST['MulBranchId']!=''){
