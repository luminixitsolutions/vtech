            ...
            <div class="layout-container">
               ...
               <?php  
                if(isset($_POST['submit'])){
                    ...
                    echo "<script>window.open('print-project-abstract-of-abstract.php?projid=$projid&SubHeadProjectId=$SubHeadProjectId');</script>";
                                ...
                                <div class="card mb-2">
                                    ...
                                    <div id="accordion2-2" class="collapse show" data-parent="#accordion2">
                                        ...
                                        <label class="form-label">District </label>
                                            <select class="select2-demo form-control" id="SubHeadProjectId" name="SubHeadProjectId[]" required="" multiple>
<option selected="" value="all">All Project Sub Head</option>
 <?php 
        $CountryId = $row7['CountryId'];
        $q = "SELECT * FROM tbl_rooftop_project_sub_head WHERE UnderBy='".$_GET['projid']."' ORDER BY Name ASC";
        $r = $conn->query($q);
