...
<label class="form-label"> Assign Lead Management</label>
 ...
 <?php  
                                        $sql33 = "SELECT * FROM tbl_options WHERE id IN(64,44,45,46,47,63,51,49,50)";
                                        $row33 = getList($sql33);
...
<label class="form-label"> Assign Other Access</label>
 ...
 <?php  
                                        $sql33 = "SELECT * FROM tbl_options WHERE id IN(55,79,18,130,131,147,148,132,133,134,25,58,70,60,71,26,82,83,167,84,84,93,94,95,96,118,138,139)";
                                        $row33 = getList($sql33);
                                        foreach($row33 as $result){
                                        ?>
                                        <div class="form-group col-md-4">
