...
<head>
    <title><?php echo $Proj_Title; ?> | Rooftop Customer Account List</title>
    <meta charset="utf-8">
            ...
            <div class="layout-container">
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0">View Rooftop Customer
                            <?php if (in_array("14", $Options)) { ?>
                                <span style="float: right;">
                                    <a href="add-rooftop-customer.php" class="btn btn-secondary btn-round"><i class="ion ion-md-add mr-2"></i> Add New</a></span><?php } ?>
                        </h4>
