...
$MainPage="Store-Incharge";
$Page = "Add-Store-Incharge";
?>
<!DOCTYPE html>
...
<label class="form-label"> Pump Store<span class="text-danger">*</span></label>
...
<div class="clearfix"></div>
 ...
 <div class="form-group col-md-3">
<label class="form-label"> Rooftop Store<span class="text-danger">*</span></label>
 <select class="form-control" name="RooftopBranchId" id="RooftopBranchId" required>
<?php 
 if($Roll == 1 || $Roll == 7){?>
<option selected="" value="">Select Store</option>
<?php }
...
<div class="clearfix"></div>
                                       ...
                                       <div class="form-group col-md-12">
                                            <label class="form-label">Store Incharge Name <span
...
<div class="form-group col-md-3 showall">
                                            ...
                                            <select class="form-control" name="Roll" id="Roll">
                                                ...
                                                <?php 
                                        $q = "select * from tbl_user_type WHERE Status=1 AND id=27 ORDER BY Name";
                                        $r = $conn->query($q);
    ...
    <?php include_once __DIR__ . '/../inc-menu-access-account-script.php'; renderMenuAccessAccountScript(27); ?>
