...
if($row7['PumpHead']==''){
    ...
    $sql54 = "SELECT * FROM tbl_rooftop_common_master WHERE Name='$PumpHead2' AND Roll=1";
...
?>
    <script type="text/javascript">
      alert("Deleted Successfully!");
       window.location.href="add-rooftop-customer.php?id=<?php echo $pid;?>";
    </script>
<?php }
?>
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0"><?php if($_GET['id']) {?>Edit <?php } else{?> Add
                            <?php } ?> Rooftop Customer Account</h4>
...
<?php }
 if($Roll == 1 || $Roll == 7){
  ...
  $sql12 = "SELECT * FROM tbl_rooftop_branch WHERE Status='1' AND id IN($BranchId)";
}
...
<select class="form-control" id="AgencyId" name="AgencyId" onchange="getProdList(document.getElementById('Surface').value,document.getElementById('PumpCapacity').value,document.getElementById('WaterSource').value,document.getElementById('BoreDia').value,document.getElementById('PumpHead').value,document.getElementById('AgencyId').value,document.getElementById('PumpOutletSize').value)" required>
...
<option selected="" disabled="">Select Sub Head</option>
  <?php 
        $q = "select * from tbl_rooftop_project_sub_head WHERE Status='1' AND UnderBy='".$row7['ProjectId']."'";
        $r = $conn->query($q);
        while($rw = $r->fetch_assoc())
    {
?>
                                        ...
                                        <div class="form-group col-md-3">
                                         ...
                                         <div class="form-group col-md-9">
                                            ...
                                            <input type="text" name="Address" class="form-control" placeholder="Address"
                                                autocomplete="off" required value="<?php echo $row7["Address"]; ?>">
                                            <div class="clearfix"></div>
                                        </div>
...
<input type="hidden" value="12345" name="Password" id="Password">
 ...
 --><div class="form-group col-md-4">
 <label class="form-label">Sanction Order No</label>
                                        ...
                                        <div class="form-group col-md-4 Rooftop" style="display:block;">
                                            ...
                                            <select class="form-control" id="RooftopPlantCapacity" name="RooftopPlantCapacity" required >
<option selected="" disabled="">Select</option>
  <?php 
        $q = "select * from tbl_rooftop_common_master WHERE Status='1' AND Roll=2 ORDER BY Name ASC";
        $r = $conn->query($q);
        while($rw = $r->fetch_assoc())
    {
?>
                <option <?php if($row7['RooftopPlantCapacity']==$rw['id']){ ?> selected <?php } ?> value="<?php echo $rw['id']; ?>"><?php echo $rw['Name']; ?></option>
              <?php } ?>
</select>
...
<label class="form-label"> Dealer<span class="text-danger">*</span></label>
 <select class="select2-demo form-control" name="DealerId" id="DealerId" >
<option selected="" value="0">No Dealer</option>
 <?php 
  $sql12 = "SELECT id,Fname FROM tbl_users WHERE Status='1' AND Roll=9";
  $row12 = getList($sql12);
  foreach($row12 as $result){
     ?>
  <option <?php if($row7['DealerId'] == $result['id']) {?> selected <?php } ?> value="<?php echo $result['id'];?>">
    <?php echo $result['Fname']; ?></option>
<?php } ?>
</select>
<div class="clearfix"></div>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label class="form-label">Dealer Commision Amt </label>
                                            <input type="number" name="DealerAmt" id="DealerAmt" class="form-control"
                                                placeholder="" value="<?php echo $row7["DealerAmt"]; ?>">
                                            <div class="clearfix"></div>
                                        </div>
...
<div class="form-group col-md-6 maindoc">
  <label class="form-label">Upload Front Aadhar Card Of Customer </label>
...
<div class="form-group col-md-6 maindoc">
  <label class="form-label">Upload Back Aadhar Card Of Customer </label>
<label class="custom-file">
...
<div class="form-group col-md-6 maindoc">
  <label class="form-label">Upload Front Pan Card Of Customer </label>
<label class="custom-file">
...
<div class="form-group col-md-6 maindoc">
  <label class="form-label">Upload Back Pan Card Of Customer </label>
<label class="custom-file">
