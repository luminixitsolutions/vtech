                            ...
                            <div class="card ipd-shell mb-4">
                                ...
                                <div class="card-body ipd-body">
                                    ...
                                    <div class="ipd-stat-grid">
                                        <?php
                                        $sql = "SELECT * FROM tbl_rooftop_project_sub_head WHERE UnderBy='" . $projectId . "'";
                                        $row = getList($sql);
                                        if (empty($row)) {
                                        ?>
                                        ...
                                        foreach ($row as $result) {
                                            ...
                                            $sql4 = "SELECT * FROM tbl_users WHERE ProjectId='" . $projectId . "' AND ProjectSubHeadId='" . $subHeadId . "' AND ProjectType=2 AND Roll=5";
                                            $rncnt4 = getRow($sql4);
                                        ?>
