...
$sql = "SELECT d.id, d.DistId, d.ProductName, d.SerialNo, d.Qty, d.Purity, d.ModelNo, d.ProdType, d.VehicalDate, d.VehicalNo, tb.Name AS StoreName
        ...
        LEFT JOIN tbl_rooftop_distibute_items h ON h.id = d.DistId AND h.Status = 1
        LEFT JOIN tbl_rooftop_branch tb ON tb.id = h.BranchId
...
<p class="small text-muted mb-0"><?php echo count($rows); ?> line(s) will be given to the dispatch officer.</p>
<?php
$html = ob_get_clean();
