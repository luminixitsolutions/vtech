                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_purchase_order";
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        <div class="d-flex align-items-center">
                                          ...
                                          <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_purchase_order WHERE InvoiceDate='".date('Y-m-d')."'";
                                                            echo $rncnt4 = getRow($sql4);
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        <div class="d-flex align-items-center">
                                          ...
                                          <div class="text-large"><?php  
                                                $sql4 = "SELECT * FROM tbl_rooftop_sell WHERE InvoiceDate='".date('Y-m-d')."'";
                                                echo $rncnt4 = getRow($sql4);
                                                ?></div>
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        <div class="d-flex align-items-center">
                                          ...
                                          <div class="text-large"><?php  
                                                $sql4 = "SELECT * FROM tbl_rooftop_sell";
                                                echo $rncnt4 = getRow($sql4);
                                                ?></div>
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        <div class="d-flex align-items-center">
                                          ...
                                          <div class="text-large"><?php  
                                                $sql4 = "SELECT * FROM tbl_rooftop_quotation";
                                                echo $rncnt4 = getRow($sql4);
                                                ?></div>
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        <div class="d-flex align-items-center">
                                          ...
                                          <div class="text-large"><?php  
                                                $sql4 = "SELECT * FROM tbl_rooftop_work_order";
                                                echo $rncnt4 = getRow($sql4);
                                                ?></div>
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        <div class="d-flex align-items-center">
                                          ...
                                          <div class="text-large"><?php  
                                                $sql4 = "SELECT * FROM tbl_rooftop_service_complaint";
                                                echo $rncnt4 = getRow($sql4);
                                                ?></div>
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        <div class="d-flex align-items-center">
                                          ...
                                          <div class="text-large"><?php  
                                                $sql4 = "SELECT * FROM tbl_rooftop_service_complaint WHERE CreatedDate='".date('Y-m-d')."'";
                                                echo $rncnt4 = getRow($sql4);
                                                ?></div>
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        <div class="d-flex align-items-center">
                                          ...
                                          <div class="text-large"><?php  
                                                $sql4 = "SELECT * FROM tbl_rooftop_service_complaint WHERE ServiceType='Insurance'";
                                                echo $rncnt4 = getRow($sql4);
                                                ?></div>
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        <div class="d-flex align-items-center">
                                          ...
                                          <div class="text-large"><?php  
                                                $sql4 = "SELECT * FROM tbl_rooftop_service_complaint WHERE ServiceType='Insurance' AND CreatedDate='".date('Y-m-d')."'";
                                                echo $rncnt4 = getRow($sql4);
                                                ?></div>
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        <div class="d-flex align-items-center">
                                          ...
                                          <div class="text-large"><?php  
                                               $sql = "SELECT * FROM tbl_rooftop_products";
