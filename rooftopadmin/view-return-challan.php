...
$items = getList("SELECT * FROM rooftop_challan_return_items WHERE return_id='" . (int) $returnRec['id'] . "' ORDER BY id ASC");
$logs = getList("SELECT cel.*, tu.Fname AS PerformedByName FROM rooftop_challan_edit_log cel LEFT JOIN tbl_users tu ON tu.id=cel.performed_by WHERE cel.sell_id='$sellId' ORDER BY cel.id DESC");
?>
<!DOCTYPE html>
                    ...
                    <div class="container flex-grow-1 container-p-y">
                        <h5 class="font-weight-bold py-3 mb-0">
                            ...
                            <span style="float:right;">
                                ...
                                <?php
                                $sellRow = getRecord("SELECT ReturnStatus FROM tbl_rooftop_sell WHERE id='$sellId' LIMIT 1");
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body table-responsive">
                                <table class="table table-bordered table-striped">
                                    <thead><tr><th>#</th><th>Product</th><th>Model No</th><th>Serial No</th><th>Qty</th><th>Unit</th><th>Type</th></tr></thead>
                                    <tbody>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body table-responsive">
                                <table class="table table-bordered table-striped">
                                    <thead><tr><th>#</th><th>Action</th><th>Performed By</th><th>Remarks</th><th>Date</th></tr></thead>
                                    <tbody>
