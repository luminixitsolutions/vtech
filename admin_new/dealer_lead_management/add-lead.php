              ...
              <?php include_once '../top_header.php'; ?>
                ...
                <div class="layout-content">
                    ...
                    <div class="container flex-grow-1 container-p-y">
                        <h5 class="font-weight-bold py-3 mb-0">Add Dealer Lead</h5>
                        
 <?php 
$id = $_GET['id'];
$sql7 = "SELECT * FROM tbl_dealer_leads WHERE id='$id'";
$row7 = getRecord($sql7);
...
if($_GET['id']==''){
     $qx = "INSERT INTO tbl_dealer_leads SET CustId='$CustId',CellNo='$CellNo',CustName = '$CustName',Status='$Status',Address='$Address',DocumentsStatus='$DocumentsStatus',ClainReason = '$ClainReason',ClainStatus='$ClainStatus',CreatedDate='$CreatedDate',CreatedBy='$user_id',BranchId='$BranchId'";
  $conn->query($qx);
   $PostId = mysqli_insert_id($conn);
  $TicketNo= "#".rand(1000,9999);
  $sql = "UPDATE tbl_dealer_leads SET TicketNo='$TicketNo' WHERE id='$PostId'";
  $conn->query($sql);
  ...
  echo "<script>alert('Lead Record Saved Successfully!');window.location.href='view-leads.php';</script>";
    ...
    $query2 = "UPDATE tbl_dealer_leads SET CustId='$CustId',CellNo='$CellNo',CustName = '$CustName',Status='$Status',Address='$Address',DocumentsStatus='$DocumentsStatus',ClainReason = '$ClainReason',ClainStatus='$ClainStatus',ModifiedDate='$ModifiedDate',ModifiedBy='$user_id',BranchId='$BranchId' WHERE id = '$id'";
  $conn->query($query2);
