              ...
              <?php include_once '../top_header.php'; ?>
                ...
                <div class="layout-content">
                    ...
                    <div class="container flex-grow-1 container-p-y">
                        <h5 class="font-weight-bold py-3 mb-0">Dealer Lead Dashboard</h5>
                        

                        <div class="row">
                            <?php 
                                $sql2 = "SELECT * FROM tbl_dealer_leads";
                                $rncnt2 = getRow($sql2);
                            ?>
                            ...
                            <?php 
                                ...
                                foreach($row as $result){
                                    ...
                                    $sql2 = "SELECT * FROM tbl_dealer_leads WHERE ClainStatus='".$result['Name']."'";
                                    $rncnt2 = getRow($sql2);
                            ?>
                            <div class="col-sm-6 col-xl-2">
