...
$WoNo = addslashes(trim($_POST['WoNo']));
$ProjectId = addslashes(trim($_POST['ProjectId']));
$SelectionDoneBy = addslashes(trim($_POST['SelectionDoneBy']));
$ProjectSubHeadId = addslashes(trim($_POST['ProjectSubHeadId']));
$TotalAmount = $_POST['TotalAmount'];
$SelectionDoneByContractor = $_POST['SelectionDoneByContractor'];
...
if($ProjectType == 1){
    if($BagId!=0){
        $sql33 = "SELECT ProductName FROM tbl_products WHERE id='$BagId'";
        $row33 = getRecord($sql33);
        $BagProdName = $row33['ProductName'];
         $sql = "INSERT INTO tbl_cust_product_specification SET CustId='$EmpId',AcDc='',Surface='',PumpCapacity='',WaterSource='',BoreDia='',PumpHead='',ProdId='$BagId',ProdName='$BagProdName',Unit='BAG',Qty='1',CreatedBy='$user_id',CreatedDate='$CreatedDate',SpecType='2',ModuleWatt='',ModuleQty='',Structure='0',AgencyId='',PumpOutletSize=''";
                $conn->query($sql);
    }
            ...
            if(trim($_POST["ProdId"][$i] != ''))  
              {
                ...
                $SpecType = addslashes(trim($_POST['SpecType'][$i]));
                $Unit = $_POST['Unit'][$i];
                $Qty = $_POST['Qty'][$i];
                 $Structure = $_POST['Structure'][$i];
              
                $sql = "INSERT INTO tbl_cust_product_specification SET CustId='$EmpId',AcDc='$AcDc',Surface='$Surface',PumpCapacity='$PumpCapacity',WaterSource='$WaterSource',BoreDia='$BoreDia',PumpHead='$PumpHead',ProdId='$ProdId',ProdName='$ProdName',Unit='$Unit',Qty='$Qty',CreatedBy='$user_id',CreatedDate='$CreatedDate',SpecType='$SpecType',ModuleWatt='$ModuleWatt',ModuleQty='$ModuleQty',Structure='$Structure',AgencyId='$AgencyId',PumpOutletSize='$PumpOutletSize'";
                $conn->query($sql);
            }
        }
    }
...
if($TotalAmount > 0){
    $sql = "INSERT INTO tbl_general_ledger SET UserId='$EmpId',AccountName='$Fname',Amount='$TotalAmount',PaymentDate='$CreatedDate',CrDr='cr',Roll=5,Type='CINV',CreatedDate='$CreatedDate',SellType='CustInv'";
    $conn->query($sql);
}

if($SelectionDoneByContractor!=0){
$sql = "SELECT PumpCapacity,ProjectId,ProjectSubHeadId FROM tbl_users WHERE id='$EmpId'";
                        $row = getRecord($sql);
                        $PumpCapacity = $row['PumpCapacity'];
                        $ProjectHeadId = $row['ProjectId'];
                        $ProjectSubHeadId = $row['ProjectSubHeadId'];

                        $sql2 = "SELECT SelectionVal FROM tbl_contractor_commision WHERE UserId='$SelectionDoneByContractor' AND Capacity='$PumpCapacity' AND ProjectHeadId='$ProjectHeadId' AND ProjectSubHeadId='$ProjectSubHeadId'";
                        $row2 = getRecord($sql2);
                        $Amount = $row2['SelectionVal'];

                        $sql = "DELETE FROM tbl_made_contractor_commision WHERE CustId='$EmpId' AND Roll=1";
                        $conn->query($sql);

                        $sql = "INSERT INTO tbl_made_contractor_commision SET ContractorId='$SelectionDoneByContractor',CustId='$EmpId',Capacity='$PumpCapacity',ScopeOfWork='Selection',Amount='$Amount',CreatedDate='$FoundationDate',Roll=1";
                        $conn->query($sql);
}
echo 1;
}
...
$conn->query($sql);
if($TotalAmount > 0){
    $sql = "INSERT INTO tbl_general_ledger SET UserId='$id',AccountName='$Fname',Amount='$TotalAmount',PaymentDate='$CreatedDate',CrDr='cr',Roll=5,Type='CINV',CreatedDate='$CreatedDate',SellType='CustInv'";
    $conn->query($sql);
}


if($SelectionDoneByContractor!=0){
$sql = "SELECT PumpCapacity,ProjectId,ProjectSubHeadId FROM tbl_users WHERE id='$id'";
                        $row = getRecord($sql);
                        $PumpCapacity = $row['PumpCapacity'];
                        $ProjectHeadId = $row['ProjectId'];
                        $ProjectSubHeadId = $row['ProjectSubHeadId'];
                        ...
                        $sql = "DELETE FROM tbl_made_contractor_commision WHERE CustId='$id' AND Roll=1";
                        $conn->query($sql);

                        $sql = "INSERT INTO tbl_made_contractor_commision SET ContractorId='$SelectionDoneByContractor',CustId='$id',Capacity='$PumpCapacity',ScopeOfWork='Selection',Amount='$Amount',CreatedDate='$CreatedDate',Roll=1";
                        $conn->query($sql);
}
...
if($ProjectType == 1){
    ...
    if($BagId!=0){
        ...
        $row33 = getRecord($sql33);
        $BagProdName = $row33['ProductName'];
          $sql = "INSERT INTO tbl_cust_product_specification SET CustId='$id',AcDc='',Surface='',PumpCapacity='',WaterSource='',BoreDia='',PumpHead='',ProdId='$BagId',ProdName='$BagProdName',Unit='BAG',Qty='1',CreatedBy='$user_id',CreatedDate='$CreatedDate',SpecType='2',ModuleWatt='',ModuleQty='',Structure='0',AgencyId='',PumpOutletSize=''";
                $conn->query($sql);
    }
    if($_POST["ProdId"] == ''){
        $number = 0;
            ...
            if(trim($_POST["ProdId"][$i] != ''))  
              {
                ...
                $sql = "INSERT INTO tbl_cust_product_specification SET CustId='$id',AcDc='$AcDc',Surface='$Surface',PumpCapacity='$PumpCapacity',WaterSource='$WaterSource',BoreDia='$BoreDia',PumpHead='$PumpHead',ProdId='$ProdId',ProdName='$ProdName',Unit='$Unit',Qty='$Qty',CreatedBy='$user_id',CreatedDate='$CreatedDate',SpecType='$SpecType',ModuleWatt='$ModuleWatt',ModuleQty='$ModuleQty',Structure='$Structure',AgencyId='$AgencyId',PumpOutletSize='$PumpOutletSize'";
                $conn->query($sql);
            }
        }
    }
