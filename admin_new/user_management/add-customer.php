...
<label class="form-label"> Bag</label>
 <select class="select2-demo form-control" name="BagId" id="BagId">
<option selected="" value="0">No One</option>
 <?php 
  $sql12 = "SELECT * FROM tbl_products WHERE Status=1 AND Roll=2";
  $row12 = getList($sql12);
  foreach($row12 as $result){
     ?>
  <option <?php if($row7["BagId"] == $result['id']) {?> selected <?php } ?> value="<?php echo $result['id'];?>">
