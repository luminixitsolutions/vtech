                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            if ($FromBranchId > 0 && $ToBranchId > 0) {
                                ?>
                                <form method="post" action="save-store-to-store-transfer.php" id="storeTransferForm">
                                    ...
                                    <div class="form-group mb-3 p-3 bg-light rounded border">
                                        ...
                                        <a href="view-store-to-store-transfers.php" class="btn btn-secondary btn-lg">View Transfers</a>
