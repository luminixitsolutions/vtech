 <div class="row">
                    ...
                    LEFT JOIN tbl_users tu ON tdo.CustId=tu.id WHERE tdo.Inst_Dispatcher_Otp_Verify=1 AND tu.ProjectId='107' AND tu.Roll=5 AND tu.ProjectType=1";
                                                            echo $rncnt4 = getRow($sql4);
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        ...
                                        <div class="text-large"><?php  
                                                          ...
                                                          $sql4 = "SELECT tdo.*,tu.Fname,tu.Phone,tu.Address FROM tbl_sell tdo 
                    LEFT JOIN tbl_users tu ON tdo.CustId=tu.id WHERE tdo.Inst_Dispatcher_Otp_Verify=1 AND tu.ProjectId='107' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND tu.ProjectType=1";
                                                            $rncnt4 = getRow($sql4);
                                                            echo $rncnt47 - $rncnt4;
                                                        ?></div>
                    ...
                    LEFT JOIN tbl_users tu ON ti.CustId=tu.id WHERE tu.ProjectId='107' AND tu.Roll=5 AND ti.InstallStatus='Yes' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.ProjectType=1";
                                                            echo $rncnt4 = getRow($sql4);
