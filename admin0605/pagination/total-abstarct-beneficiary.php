...
$sql = "SELECT ts.*, tu.* FROM tbl_sell ts INNER JOIN tbl_users tu ON tu.id=ts.CustId WHERE ts.SellType='Challan' AND tu.ProjectType=1 AND tu.ProjectId='$ProjectId' AND tu.District!='' AND tu.ProjectSubHeadId='$ProjectSubHeadId'";
if($dist !=''){
    $sql.=" AND tu.District='$dist'";
}
}
