              ...
              <?php include_once '../top_header.php'; ?>
                ...
                <div class="layout-content">
                    ...
                    <div class="container flex-grow-1 container-p-y">
                        <h5 class="font-weight-bold py-3 mb-0">Upload Dealer Lead Excel</h5>
...
$CreatedTime = date('h:i a');
                ...
                if (!empty($CellNo) || !empty($CustName) || !empty($Address)) {
                     ...
                     $qx = "INSERT INTO tbl_dealer_leads SET TicketNo='$TicketNo',CustId='$CustId',CellNo='$CellNo',CustName = '$CustName',Status='1',Address='$Address',DocumentsStatus='',ClainReason = '$ClainReason',ClainStatus='In Progress',CreatedDate='$CreatedDate',CreatedBy='$user_id'";
                    $conn->query($qx);
                    $PostId = mysqli_insert_id($conn);
                    $n = 10;
                    $Code2 = RandomStringGenerator($n); 
                    $Code = $Code2."".$PostId;
                    $sql = "UPDATE tbl_dealer_leads SET code='$Code' WHERE id='$PostId'";
                    $conn->query($sql);
  ...
  $conn->query($sql);
         ...
         $sql = "DELETE FROM tbl_dealer_leads WHERE CellNo='CellNo'";
         $conn->query($sql);
?>
<script>
