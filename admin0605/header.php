...
<li class="sidenav-item <?php if($MainPage=='Item-Transfer-Workflow' && ($Page=='Dispatch-To-Store-Transfer' || $Page=='View-Dispatch-To-Store-Transfers')) {?> open active <?php } ?>">
<a href="javascript:" class="sidenav-link sidenav-toggle">
 <i class="sidenav-icon feather icon-activity"></i>
...
<li class="sidenav-item <?php if($MainPage=='Item-Transfer-Workflow' && ($Page=='Store-To-Store-Transfer' || $Page=='View-Store-To-Store-Transfers')) {?> open active <?php } ?>">
<a href="javascript:" class="sidenav-link sidenav-toggle">
 <i class="sidenav-icon feather icon-activity"></i>
