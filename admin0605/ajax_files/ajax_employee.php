...
$UnderByManager = addslashes(trim($_POST['UnderByManager']));
$UnderByGrManager = addslashes(trim($_POST['UnderByGrManager']));
$UnderByBusHead = addslashes(trim($_POST['UnderByBusHead']));
