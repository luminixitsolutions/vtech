...
<input type="hidden" id="RmsIntegrationStatus" value="<?php echo isset($_GET['RmsIntegrationStatus']) ? $_GET['RmsIntegrationStatus'] : '';?>">
<input type="hidden" id="RmsIntegration7Days" value="<?php echo isset($_GET['RmsIntegration7Days']) ? $_GET['RmsIntegration7Days'] : '';?>">
<input type="hidden" id="RmsIntegration90Days" value="<?php echo isset($_GET['RmsIntegration90Days']) ? $_GET['RmsIntegration90Days'] : '';?>">
...
<script src="assets/js/pages/forms_selects.js"></script>
    <script>
        ...
        $(document).ready(function(){
         $.fn.myFunction = function(ProjectId,InstallStatus,PoInspection,DgmApproval,InsuranceApproval,PaymentDone,CircleOfficeStatus,RmsIntegrationStatus,RmsIntegration7Days,RmsIntegration90Days,IcrSignDoOffice,BillForward,RoToRoAccts,RoAcctsToZo,ZoToHo,HoToHoAccts,ForwardToPayment,DispatchStatus,District,SentToHo,FileInHand,SubHeadId){ 
            var PageLength = 5000;
         $('#empTable').DataTable({
                'processing': true,
                'serverSide': true,
                ...
                'ajax': {
                    ...
                    data: {
                        ...
                        RmsIntegration7Days:RmsIntegration7Days,
                        RmsIntegration90Days:RmsIntegration90Days,
    ...
    var RmsIntegration7Days = $('#RmsIntegration7Days').val();
    var RmsIntegration90Days = $('#RmsIntegration90Days').val();
    ...
    $.fn.myFunction(ProjectId,InstallStatus,PoInspection,DgmApproval,InsuranceApproval,PaymentDone,CircleOfficeStatus,RmsIntegrationStatus,RmsIntegration7Days,RmsIntegration90Days,IcrSignDoOffice,BillForward,RoToRoAccts,RoAcctsToZo,ZoToHo,HoToHoAccts,ForwardToPayment,DispatchStatus,District,SentToHo,FileInHand,SubHeadId);
