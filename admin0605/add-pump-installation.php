        ...
        <div class="layout-inner">
            ...
            <div class="layout-container">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $RmsIntegration7Days = addslashes(trim($_POST['RmsIntegration7Days']));
                    $RmsIntegration90Days = addslashes(trim($_POST['RmsIntegration90Days']));
                    $ImeiNo = addslashes(trim($_POST['ImeiNo']));
...
<div class="form-group col-md-6">
 ...
 -->
                                        ...
                                        <div class="form-group col-md-3">
                                            <label class="form-label">RMS Integration 7 days</label>
                                            <select class="form-control" id="RmsIntegration7Days" name="RmsIntegration7Days">
                                                <option value="No" <?php if (isset($row7["RmsIntegration7Days"]) && $row7["RmsIntegration7Days"] == 'No') { ?> selected
                                                    <?php } ?>>No</option>
                                                <option value="Yes" <?php if (isset($row7["RmsIntegration7Days"]) && $row7["RmsIntegration7Days"] == 'Yes') { ?> selected
                                                    <?php } ?>>Yes</option>
                                            </select>
                                            <div class="clearfix"></div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label class="form-label">RMS Integration 90 days</label>
                                            <select class="form-control" id="RmsIntegration90Days" name="RmsIntegration90Days">
                                                <option value="No" <?php if (isset($row7["RmsIntegration90Days"]) && $row7["RmsIntegration90Days"] == 'No') { ?> selected
                                                    <?php } ?>>No</option>
                                                <option value="Yes" <?php if (isset($row7["RmsIntegration90Days"]) && $row7["RmsIntegration90Days"] == 'Yes') { ?> selected
                                                    <?php } ?>>Yes</option>
                                            </select>
                                            <div class="clearfix"></div>
                                        </div>
                                       ...
                                       <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-3">
                                           ...
                                           <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="ImeiNo" id="ImeiNo" class="form-control"
                                                placeholder="" value="<?php echo $row7["ImeiNo"]; ?>"
                                                autocomplete="off">
                                            <div class="clearfix"></div>
                                        </div>
