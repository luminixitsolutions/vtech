...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    if ($action === 'approve') {
        ...
        $ext = getRecord("
            ...
            AND e.next_approver_role='BUSINESS_HEAD'
        ...
        // Apply extension to installation flow
        mysqli_query($conn,"
        ...
        mysqli_query($conn,"
            ...
            ('$flowId','$user_id','EXTENSION_APPROVED',
             'Extension approved by Business Head',NOW())
        ");
    ...
    if ($action === 'reject') {
        ...
        mysqli_query($conn,"
            ...
            ('$flowId','$user_id','EXTENSION_REJECTED',
             'Extension rejected by Business Head',NOW())
        ");
...
<h4 class="font-weight-bold mb-3">
    Business Head - Extension Requests
</h4>
