            ...
            <div class="layout-container">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    foreach ($_SESSION["cart_item"] as $product) {
                        ...
                        echo $sql22 = "INSERT INTO tbl_purchase_order_products SET SGST='$SGST',CGST='$CGST',IGST='$IGST',UserId='$CustId',SellId='$SellId',ProductName='$ProductName',Purity='$Purity',Weight='$Weight',Price='$Price',Making='$Making',HmCharge='$HmCharge',Qty='$Qty',TotalRate='$TotalRate',ProductId='$ProductId',ModelNo='$ModelNo',SellDate='$InvoiceDate'";
                        $conn->query($sql22);
                    ...
                    echo "<script>alert('New Purchase Order Created Successfully!');window.location.href='view-bag-purchase-order.php';</script>";
                }
                unset($_SESSION["cart_item"]);
                ?>
...
<div class="clearfix"></div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <select name="ProductId[]" id="ProductId1" onchange="getProdDetails(this.value,document.getElementById('srno1').value)" class="select2-demo form-control">
                                                                    ...
                                                                    <?php
                                                                    $sql12 = "SELECT * FROM tbl_products WHERE Status='1' AND Roll!=0 ORDER BY ProductName";
                                                                    $row12 = getList($sql12);
                                                                    foreach ($row12 as $result) {
    ...
    if ($result['Roll'] == 2) {
        ...
        $displayName .= " (Serial No)";
                                                                    ...
                                                                    ?>
                                                                        <option value="<?php echo $result['id']; ?>"><?php echo $displayName; ?></option>
                                                                    <?php } ?>
                                                                </select>
