            ...
            <div class="welcome-area">
                ...
                <div class="join-area h-50">
                    ...
                    <input class="form-control" type="hidden" autocomplete="off" name="Phone" placeholder="Phone No" id="Phone" value="<?php echo $_REQUEST['phone'];?>">
                        ...
                        <input type="hidden" name="InstId" id="InstId" value="<?php echo $_REQUEST['instid'];?>">
...
<script src="login/assets/js/custom.js"></script>
 <script type="text/javascript">
         ...
         $(document).on("click", "#submit", function(event){
                var action = "InstallationOtpVerify";
                var id = $('#id').val();
                ...
                method:"POST",  
                data:{action:action,id:id,getotp:getotp,YourOtp:YourOtp,InstId:InstId},
                 beforeSend:function(){
                   ...
                   // alert(data);
                     ...
                     if(data == 0){
                      ...
                      setTimeout(function(){  
                        ...
                        window.location.href="installations_status.php";
